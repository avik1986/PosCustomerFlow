...
public class CustomerAsserts {
    ...
    public static void assertCustomerUpdatableFieldsEquals(Customer expected, Customer actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getFname()).as("check fname").isEqualTo(expected.getFname()))
            .satisfies(a -> assertThat(a.getLname()).as("check lname").isEqualTo(expected.getLname()))
            .satisfies(a -> assertThat(a.getMobileNo()).as("check mobileNo").isEqualTo(expected.getMobileNo()))
            .satisfies(a -> assertThat(a.getEmailId()).as("check emailId").isEqualTo(expected.getEmailId()))
            .satisfies(a -> assertThat(a.getRposCustomerId()).as("check rposCustomerId").isEqualTo(expected.getRposCustomerId()))
