...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="posCustomerFlowApp.customer.delete.question">
        <Translate contentKey="posCustomerFlowApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
