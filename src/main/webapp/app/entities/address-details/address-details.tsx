            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="posCustomerFlowApp.addressDetails.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      {addressDetails.customer ? (
                        <Link to={`/customer/${addressDetails.customer.id}`}>{addressDetails.customer.id}</Link>
                      ) : (
                        ''
                      )}
                    </td>
