...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADDRESSDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADDRESSDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADDRESSDETAILS actions', async () => {
      const arg = { id: 26351 };
    ...
    it('dispatches UPDATE_ADDRESSDETAILS actions', async () => {
      const arg = { id: 26351 };
    ...
    it('dispatches PARTIAL_UPDATE_ADDRESSDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADDRESSDETAILS actions', async () => {
      const arg = 42666;
