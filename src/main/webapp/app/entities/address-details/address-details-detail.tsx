    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="posCustomerFlowApp.addressDetails.customer">Customer</Translate>
          </dt>
          <dd>{addressDetailsEntity.customer ? addressDetailsEntity.customer.id : ''}</dd>
        </dl>
