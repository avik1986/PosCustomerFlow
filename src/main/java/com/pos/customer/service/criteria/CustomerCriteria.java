...
public class CustomerCriteria implements Serializable, Criteria {
    ...
    public CustomerCriteria(CustomerCriteria other) {
        ...
        this.addressDetailsId = other.optionalAddressDetailsId().map(LongFilter::copy).orElse(null);
    ...
    public Optional<LongFilter> optionalAddressDetailsId() {
        return Optional.ofNullable(addressDetailsId);
    }

    public LongFilter addressDetailsId() {
        if (addressDetailsId == null) {
            setAddressDetailsId(new LongFilter());
        }
        return addressDetailsId;
    }
    ...
    public String toString() {
        return "CustomerCriteria{" +
            ...
            optionalAddressDetailsId().map(f -> "addressDetailsId=" + f + ", ").orElse("") +
